...
$(document).on('change', '.checkbox1', function() {
    ...
    $(document).ready(function() {
        ...
        var table=$('#myTable').DataTable(
             ...
             { "order": 
               [[<?php if(!empty($_SESSION['archive']['column'])) { echo $_SESSION['archive']['column']; } else { echo 0; } ?>, '<?php if(!empty($_SESSION['archive']['direction'])) { echo $_SESSION['archive']['direction']; } else { echo "asc"; } ?>']]
            ,paging: false
            }
