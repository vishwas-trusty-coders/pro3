    ...
    <div class="container">
        ...
        <div id="all-user-data">
            <div class="user-row">
                ...
                $sql = "SELECT o.id,o.status,o.order_id,oi.id as oi_id,oi.name,oi.size,oi.product,oi.color,oi.design,oi.in_stock,oi.notes,oi.progress,o.created_at FROM orders as o LEFT JOIN order_items as oi ON o.id = oi.order_id where o.status='inventory'";
                $result = $conn->query($sql);
